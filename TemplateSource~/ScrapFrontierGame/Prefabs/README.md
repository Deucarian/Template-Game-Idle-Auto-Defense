...
The starter scene now builds visible gameplay from the curated Kenney Tower Defense Kit 3D models under `Resources/Kenney/IdleAutoDefense/Models/TowerDefenseKit`. Use this folder for project-specific recycler, enemy, weapon, projectile, muzzle flash, and impact prefabs when the product game is ready for authored visuals.
