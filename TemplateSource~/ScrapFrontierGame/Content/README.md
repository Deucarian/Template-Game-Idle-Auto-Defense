...
- `Enemies` contains six generic enemy definitions: Scrap Rusher, Wirejack, Plateback, Slag Caster, Foreman, and Foundry Titan.
- `Attacks` contains four authored attack recipes: Rivet Barrage, Arc Furnace, Sawblade Relay, and Salvage Mortar.
- `Weapons` contains four tower weapon definitions paired with those attacks.
- `Waves` contains seven spawn profiles: Yard Breach, Wirejack Rush, Salvage Surge, Plateback Break, Foreman Arrival, Scrapyard Storm, and Titan March.
- `Upgrades` contains six run upgrades: Rivet Pressure, Belt Speed, Spotter Optics, Hardened Feed, Bulkhead Plating, and Salvage Dividend.
...
- `GameRules` owns the objective, module roles, elite/boss references, combat, repair, projectile, and Redline values.
...
scrap, visible offscreen approaches, a first reward around 30-60 seconds,
mid-run near-leaks that can damage the recycler, and elite/boss pressure before
