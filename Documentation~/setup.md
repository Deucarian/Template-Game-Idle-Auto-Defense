...
- `Strict authored startup blocked`: open `Tools > Deucarian > Authoring > Game Content...`, validate the generated named pack, and fix the reported missing/invalid source or reference. Do not enable fallback for the normal sample.
